...
echo "Sub comparaciones"."<br>";

echo substr_compare($cade6,"de",12,2)."<br>";

echo substr_compare($cade6,"cade",-7,4)."<br>";

echo substr_compare($cade6,"subca",15,2)."<br>";

echo substr_compare($cade6,"RACION",5,6,TRUE)."<br>";

echo substr_compare($cade6,'sub',-10,4)."<br>";

echo substr_compare($cade6,'para',2,4)."<br>";
