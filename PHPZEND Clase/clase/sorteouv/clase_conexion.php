...
class conex {
	...
	function __construct(){
		...
		$this -> conexion = @mysql_connect($config["Base_Datos"]["servidor"],$config["Base_Datos"]["usuario"],$config["Base_Datos"]["password"]) or $this -> pinta_error('No se estableci&oacute; la conexi&oacute; con el servidor.');
